...
$get_to_know_title = get_sub_field('career_testimonial_heading',false,false);
if (strpos($url,'co/') !== false) {
    $co_para_check = 'co available';
}else{
    $co_para_check = 'co not available';
}
if(have_rows('career_testimonial_list') && $co_para_check == "co not available"):
?>
<section class="client_testimonial_wrapper career-testimonial">
    <div class="container">
        <?php if($get_to_know_title): ?>
            <div class="text-center">
                <?php echo $get_to_know_title; ?>
            </div>
        <?php endif; ?>
        ...
        <div class="client_testimonial client_testimonial_slider swiper animatable fadeInDown" data-delay="200">
            ...
            <?php  while(have_rows('career_testimonial_list')): the_row();?>
                <div class="testimonial_box swiper-slide">
                    ...
                    <div class="emp_details">
                        <div class="emp_name">
                            <?php if(get_sub_field('employee_name')):?>
                                <h5><?php echo get_sub_field('employee_name');?></h5>
                            <?php endif; ?>
                        </div>
                        <div class="emp_position">
                            <?php if(get_sub_field('employee_position')):?>
                                <p><?php echo get_sub_field('employee_position');?></p>
                            <?php endif; ?>
                        </div>
                    </div>
