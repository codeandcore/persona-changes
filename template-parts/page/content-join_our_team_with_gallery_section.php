...
if ($gallery && $check == 0) { ?>
 ...
 <section class="join_our_team">     
    <div class="swiper join_team_slider d-flex align-items-center">
        ...
        <div class="swiper-wrapper align-items-center carousel-container">
            <?php foreach ($gallery as $key => $value) { ?>
                <div class="swiper-slide">
                    <div class="single_team_image">
                        <a href="javascript:;"  class="fancybox-image" data-src="<?php echo $value["url"]?>">
